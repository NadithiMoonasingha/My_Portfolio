...
export default function Leadership() {
  return (
    <section id="leadership" className="py-24 px-6 max-w-6xl mx-auto">
      ...
      <h2 className="text-4xl font-bold text-white mb-12">Leadership & Activities</h2>

      <div className="flex flex-col gap-4">
        {portfolioData.leadership.map((item, index) => (
          <div
            key={index}
            className="flex items-start gap-4 bg-white/5 border border-white/10 rounded-2xl p-5 hover:border-purple-500/50 transition-all duration-300"
          >
